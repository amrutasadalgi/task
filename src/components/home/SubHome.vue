<template>
  <div>
    <v-container
      fluid
      color="blue"
      class="d-flex flex-column align-center justify-center hero px-16"
    >
...
div {
  ...
  background-image: url("https://images.unsplash.com/photo-1552581234-26160f608093?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870");
  height: 100vh;
  width: 100%;
